    ...
    var mainApp = {
        ...
        main_fun:function() {
            ...
            $(function () {
                $.vegas('slideshow', {
                    backgrounds: [
                      { src: 'indexassets/img/4.jpg', fade: 1000, delay: 9000 }, //CHANGE THESE IMAGES WITH YOUR ORIGINAL IMAGES
            ...
            $(function () {
                var $header = $("#headLine");
                var header = ['RESEARCHING...', 'DEVELOPING...', 'TRAINING...']; // CHANGE TEXT HERE TO YOUR TEXT , YOU CAN USE MANY WORDS SEPRATED BY , 
